...
public class SimpleTeseoJavaProgrammingFrame extends JFrame {
  ...
  JButton jMapButton = new JButton();
...
//    jButton1.addActionListener(new InteractiveAgentFrame_jButton1_actionAdapter(this));
    ...
    jMapButton.setToolTipText("Mapa Basico");
    jMapButton.setText("Mapa Basico");
    jMapButton.addActionListener(new 
        SimpleTeseoJavaProgrammingFrame_jMapButton_actionAdapter(this));
    jLogPanel.setLayout(borderLayout3);
    jToolBar1.add(jOpenButton);
    jToolBar1.add(jSaveButton);
    jToolBar1.add(jCompileButton);
    jToolBar1.add(jMapButton);
...
//      agent.setCommands( sb.toString() );
  ...
  public void jMapButton_actionPerformed(ActionEvent actionEvent){
      fileDir = "/home/bcd/Escritorio/Sistemas Inteligentes/Teseo/Mapas/eater-1.txt";      
      fileName = "eater-1.txt";
      try{
        BufferedReader reader = new BufferedReader( new FileReader(fileDir) );
        StringBuffer sb = new StringBuffer();
        String s = reader.readLine();
        ...
        this.setTitle(title + " [" + fileName + "]");
          ...
          System.out.println("Se totio cargando el mapa. Descargue su mapa de sitios autorizados");
          e.printStackTrace();
      }
  }
...
class SimpleTeseoJavaProgrammingFrame_jMapButton_actionAdapter
    implements ActionListener{
    private SimpleTeseoJavaProgrammingFrame adaptee;
    SimpleTeseoJavaProgrammingFrame_jMapButton_actionAdapter(
            SimpleTeseoJavaProgrammingFrame adaptee) {
        this.adaptee = adaptee;
    }
    ...
    @Override
    public void actionPerformed(ActionEvent actionEvent) {
        adaptee.jMapButton_actionPerformed(actionEvent);
    }    
}
